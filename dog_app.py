...
#convolutional layer and max pooling layer
model.add(Conv2D(32, kernel_size=2, padding='same', activation='relu', input_shape=(224, 224, 3)))
model.add(MaxPooling2D(pool_size=2))

#convolutional layer and max pooling layer
model.add(Conv2D(64, kernel_size=2, padding='same', activation='relu', input_shape=(224, 224, 3)))
model.add(MaxPooling2D(pool_size=2))
...
plot_accuracyaccuracy(Xception_history)
